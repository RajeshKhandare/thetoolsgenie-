          ...
          <section className="space-y-4 pt-4 border-t border-zinc-100">
            ...
            <div className="space-y-3">
              ...
              <div className="rounded-xl border border-zinc-100 p-4 bg-zinc-50/50">
                ...
                <p className="mt-1 text-xs text-zinc-600 leading-relaxed">
                  Most websites serialize data over the network, queue on remote VMs, and download responses. Our client-side model computes directly inside your device RAM for instantaneous feedback.
                </p>
              </div>
            </div>
          </section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {relatedTools.map((relTool: ToolMeta) => (
              <Link
                ...
                className="group rounded-xl border border-zinc-200 bg-white p-4 shadow-sm hover:border-violet-300 hover:shadow-md transition-all text-left"
              >
